...
export async function pickColorsFromCSS(
  ...
  const prompt = [
    ...
    '   - Header-Hintergrund, Brand-Variablen, Seiten-Hintergrund bevorzugen',
    '   - NIEMALS eine Logo-Palette-Farbe als Background nehmen (Logo wird darauf unsichtbar!)',
    '   - Logo muss darauf sichtbar sein — wähle eine Farbe die KONTRASTIERT mit dem Logo',
    '',
    '2. LABEL: Farbige Akzentfarbe die auf dem Background auffällt.',
    '   - Button-Farben, Link-Farben, Heading-Farben, Logo-Palette-Farben bevorzugen',
    '   - Gesättigt, kein Grau/Schwarz/Weiß',
    '   - Guter Kontrast zum Background',
    '',
    'REGELN:',
    '- Wähle NUR Hex-Farben aus der obigen Liste',
    '- Background: CSS-Farben bevorzugen (Header, Brand-Vars, Struktur-Elemente)',
    '- Label: Logo-Palette-Farben oder Button-Farben bevorzugen',
